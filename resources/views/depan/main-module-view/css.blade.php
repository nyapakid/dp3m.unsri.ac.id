    ...
    <link rel="stylesheet" href="{{ asset('assets/depan/css/bootstrap.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/depan/css/fonts.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/depan/css/akreditasi.css') }}">
