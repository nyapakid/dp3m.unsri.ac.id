    ...
    <div class="container-fluid">
        <div>
            ...
            <article class="box-icon-classic">
                <div class="unit-body">
                    <h4 class="box-icon-classic-title">SK Pendirian Universitas Sriwijaya</h4>
                    <p class="box-icon-classic-text">
                        Peraturan pemerintah Republik Indonesia<br>
                        Nomor 42 Tahun 1960<br>
                        Tentang<br> 
            ...
            <article class="box-icon-classic">
                <div class="unit-body">
                    ...
                    <h4 class="box-icon-classic-title">Penyelenggaraan E-Learning</h4>
                    <p class="box-icon-classic-text">
                        Peraturan Rektor Universitas Sriwijaya<br>
                        Nomor 10 Tahun 2020<br>
                        Tentang<br> 
            ...
            <article class="box-icon-classic">
                <div class="unit-body">
                    <h4 class="box-icon-classic-title">Panduan Kurikulum</h4>
                    <hr style="border: 2px solid blue; width: 100%; border-radius: 5px;">
            ...
            <!-- <article class="box-icon-classic">
                <div class="unit-body">
                    <h5><strong>
                        ...
                        Nomor. 0008/UN9/SK.BUK.HT/2021<br>
                        Tentang<br> 
            ...
            <article class="box-icon-classic">
                <div class="unit-body">
                    ...
                    <div class="hero-buttons mt-4">
                        <a href="https://repository.unsri.ac.id/198903/" target="_blank" class="btn btn-primary">PPID (Pejabat Pengelola Informasi dan Dokumentasi) UNSRI</a>
                    </div>
                    <div class="hero-buttons mt-4">
                        <a href="#" target="_blank" class="btn btn-primary">Kuisioner Survey Kepuasan Kerjasama dengan UNSRI</a>
                    </div>
                    <div class="hero-buttons mt-4">
                        <a href="#" target="_blank" class="btn btn-primary">Hasil Survey Kepuasan Mitra Kerjasama</a>
                    </div>
                </div>
            </article>
